...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\SuratRujukanSearch $searchModel
*/

$this->title = 'SuratRujukans';
...
?>
<div class="giiant-crud surat-rujukan-index">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Data <?= Yii::t('app', 'SuratRujukans') ?></h3>
        </div>
