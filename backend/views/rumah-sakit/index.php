...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\RumahSakitSearch $searchModel
*/

$this->title = 'RumahSakits';
...
?>
<div class="giiant-crud rumah-sakit-index">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Data <?= Yii::t('app', 'RumahSakits') ?></h3>
        </div>
