...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\ResumeMedisSearch $searchModel
*/

$this->title = 'ResumeMedis';
...
?>
<div class="giiant-crud resume-medis-index">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Data <?= Yii::t('app', 'ResumeMedis') ?></h3>
        </div>
        ...
        <div class="box-body">
			...
			[
                'attribute'=>'pasien',
                'value'=>function($data){
                    return \app\models\Pasien::findOne($data->pasien)->nama_pasien;
                }
            ],
			'diagnosa_awal',
			'diagnosa_akhir',
