...
<div class="giiant-crud resume-medis-view">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <?php $this->beginBlock('app\models\ResumeMedis'); ?>
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                            'label'=>'Nama Pasien',
                        'value'=>\app\models\Pasien::findOne($model->pasien)->nama_pasien
                    ],
                    'diagnosa_awal',
                    'diagnosa_akhir',
                    'operasi',
            ...
            <?= Tabs::widget(
                [
                    ...
                    'items' => [[
                        ...
                        'content' => $this->blocks['app\models\ResumeMedis'],
                        'active' => true,
                    ],]
                ]
            );
